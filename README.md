...
- Ademas hay otros posibles parametros que puede recibir el constructor de sequelize que se pueden ver en la [documentacion de la API](https://sequelize.org/v6/class/lib/sequelize.js~Sequelize.html#instance-constructor-constructor)